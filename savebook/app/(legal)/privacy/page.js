  ...
  return (
    <div className="min-h-screen bg-background py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-6">
            <div className="text-center">
              ...
              <div className="text-muted-foreground text-sm mt-1">Encrypted</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-green-500">🔐</div>
              <div className="text-muted-foreground text-sm mt-1">Secure</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-purple-500">📝</div>
              <div className="text-muted-foreground text-sm mt-1">Private</div>
            </div>
          </div>
        </div>

        {/* Last Updated */}
        <div className="bg-card rounded-2xl border border-border p-6 mb-8 text-card-foreground">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-foreground font-semibold">Last Updated</h3>
              <p className="text-muted-foreground">October 2025</p>
            </div>
            <div className="text-right">
              <h3 className="text-foreground font-semibold">Version</h3>
        ...
        {/* Main Content */}
        <div className="bg-card rounded-2xl border border-border p-8 text-card-foreground">
          <div className="prose prose-sm dark:prose-invert max-w-none">
            ...
            <section className="mb-12">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-foreground font-semibold mb-2">Provide Core Services</h4>
                    <p className="text-muted-foreground">To create, store, and manage your notes, and to provide you with a personalized notebook experience.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-foreground font-semibold mb-2">Security & Authentication</h4>
                    <p className="text-muted-foreground">To verify your identity, protect your account, and prevent unauthorized access to your notes.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-foreground font-semibold mb-2">Improve Our Service</h4>
                    <p className="text-muted-foreground">To understand how users interact with our app and make improvements to enhance your experience.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">To send you important updates about our service, security notifications, and support responses.</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="mb-12">
              ...
              <div className="space-y-6">
                <div className="bg-muted rounded-xl p-6 border border-border">
                  <h4 className="text-foreground font-semibold mb-3">Data Retention</h4>
                ...
                <div className="bg-muted rounded-xl p-6 border border-border">
                  <h4 className="text-foreground font-semibold mb-3">Your Rights</h4>
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div className="flex items-center">
                      <svg className="w-5 h-5 text-green-600 dark:text-green-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span className="text-muted-foreground">Access your data</span>
                    </div>
                    <div className="flex items-center">
                      <svg className="w-5 h-5 text-green-600 dark:text-green-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-muted-foreground">Delete your account</span>
                    </div>
                    <div className="flex items-center">
                      <svg className="w-5 h-5 text-green-600 dark:text-green-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span className="text-muted-foreground">Export your notes</span>
                    </div>
                  </div>
                </div>
              </div>
