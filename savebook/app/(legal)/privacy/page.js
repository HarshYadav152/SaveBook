        ...
        <div className="text-center mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-6">
            <div className="text-center">
              ...
              <div className="text-gray-600 dark:text-gray-400 text-sm mt-1">Encrypted</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-green-500">🔐</div>
              <div className="text-gray-600 dark:text-gray-400 text-sm mt-1">Secure</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-purple-500">📝</div>
              <div className="text-gray-600 dark:text-gray-400 text-sm mt-1">Private</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-50 dark:bg-slate-800 rounded-2xl border border-gray-200 dark:border-slate-700 p-8">
          <div className="prose prose-sm dark:prose-invert max-w-none">
            ...
            <section className="mb-12">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-8 h-8 bg-blue-100 dark:bg-blue-500/20 rounded-lg flex items-center justify-center mr-4 mt-1">
                ...
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-8 h-8 bg-green-100 dark:bg-green-500/20 rounded-lg flex items-center justify-center mr-4 mt-1">
                    <span className="text-green-600 dark:text-green-400 text-sm font-bold">2</span>
                  </div>
                  <div>
                    <h4 className="text-gray-900 dark:text-white font-semibold mb-2">Security & Authentication</h4>
                    <p className="text-gray-700 dark:text-gray-300">To verify your identity, protect your account, and prevent unauthorized access to your notes.</p>
                  </div>
                </div>

                <div className="flex items-start">
                  <div className="flex-shrink-0 w-8 h-8 bg-purple-100 dark:bg-purple-500/20 rounded-lg flex items-center justify-center mr-4 mt-1">
                    <span className="text-purple-600 dark:text-purple-400 text-sm font-bold">3</span>
                  </div>
                  <div>
                    <h4 className="text-gray-900 dark:text-white font-semibold mb-2">Improve Our Service</h4>
                    <p className="text-gray-700 dark:text-gray-300">To understand how users interact with our app and make improvements to enhance your experience.</p>
                  </div>
                </div>

                <div className="flex items-start">
                  <div className="flex-shrink-0 w-8 h-8 bg-orange-100 dark:bg-orange-500/20 rounded-lg flex items-center justify-center mr-4 mt-1">
                    <span className="text-orange-600 dark:text-orange-400 text-sm font-bold">4</span>
                  </div>
                  <div>
                    <h4 className="text-gray-900 dark:text-white font-semibold mb-2">Communication</h4>
                    <p className="text-gray-700 dark:text-gray-300">To send you important updates about our service, security notifications, and support responses.</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="mb-12">
              ...
              <div className="bg-gray-100 dark:bg-slate-700/30 rounded-xl p-6 border border-gray-200 dark:border-slate-600">
            ...
            <section className="mb-12">
              ...
              <div className="space-y-6">
                <div className="bg-gray-100 dark:bg-slate-700 rounded-xl p-6 border border-gray-200 dark:border-slate-600">
                  <h4 className="text-gray-900 dark:text-white font-semibold mb-3">Data Retention</h4>
                ...
                <div className="bg-gray-100 dark:bg-slate-700 rounded-xl p-6 border border-gray-200 dark:border-slate-600">
                  <h4 className="text-gray-900 dark:text-white font-semibold mb-3">Your Rights</h4>
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div className="flex items-center">
                      <svg className="w-5 h-5 text-green-600 dark:text-green-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span className="text-gray-700 dark:text-gray-300">Access your data</span>
                    </div>
                    <div className="flex items-center">
                      <svg className="w-5 h-5 text-green-600 dark:text-green-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span className="text-gray-700 dark:text-gray-300">Correct inaccurate data</span>
                    </div>
                    <div className="flex items-center">
                      <svg className="w-5 h-5 text-green-600 dark:text-green-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-700 dark:text-gray-300">Export your notes</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section className="mb-8">
              ...
              <div className="bg-gradient-to-r from-blue-50 dark:from-blue-500/10 to-purple-50 dark:to-purple-500/10 rounded-xl p-6 border border-blue-200 dark:border-blue-500/20">
                <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            {/* Policy Updates */}
            <section className="bg-gray-100 dark:bg-slate-700/30 rounded-xl p-6 border border-gray-200 dark:border-slate-600">
              <h3 className="text-gray-900 dark:text-white font-semibold mb-3 flex items-center">
