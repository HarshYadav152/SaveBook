...
export async function PUT(request, { params }) {
  ...
  try {
    ...
    const { title, description, tag, images, audio, whiteboardData, isWhiteboard } = await request.json();
    ...
    if (typeof isWhiteboard === "boolean") updatedNote.isWhiteboard = isWhiteboard;
    if (whiteboardData !== undefined) updatedNote.whiteboardData = whiteboardData ?? null;
